...
public class StaffDAO {
    private static final String INSERT_STAFF_SQL = "INSERT INTO QuanLyNhanVien_PhongBan.Staff (id,name,dateOfBirth,address,phoneNumber, email, nameDepartment) VALUES (?, ?, ?,?,?,?,?);";
    private static final String SELECT_STAFF_BY_ID = "select * from QuanLyNhanVien_PhongBan.Staff where id = ?;";
    private static final String SELECT_STAFF_BY_NAME = "select * from QuanLyNhanVien_PhongBan.Staff where name LIKE concat('%',?,'%');";
    private static final String SELECT_ALL_STAFFS = "SELECT * FROM QuanLyNhanVien_PhongBan.Staff;";
    private static final String SELECT_ALL_DEPARTMENTS = "SELECT * FROM QuanLyNhanVien_PhongBan.Department;";
    private static final String DELETE_STAFF_SQL = "delete from QuanLyNhanVien_PhongBan.Staff where id = ?;";
    private static final String UPDATE_STAFF_SQL = "update QuanLyNhanVien_PhongBan.Staff set name = ?,dateOfBirth = ?,address = ?,phoneNumber = ?,email= ?, nameDepartment =? where id = ?;";
